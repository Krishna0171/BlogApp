...
//     const refreshBefore = ACCESS_TOKEN_REFRESH_BEFORE;
//     const delay = Math.max(0, timeUntilExpiry - refreshBefore);
...
//       } else {
//         const now = Date.now();
//         const tokenExpiry = getTokenExpiry() * 1000;
//         const timeUntilLogout = tokenExpiry - now;
//         const delay = Math.max(0, timeUntilLogout);

//         scheduleLogout(delay);

//         const shouldLogout = await logoutDialog(delay);
//         if (shouldLogout) {
//           logout();
//         }
//       }
